...
<head>
	...
	<!-- css -->
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/article_index.css"/><!-- 本页样式 -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/article_index.js"></script><!-- 本页js代码 -->		
	...
	<div class="container">
		...
		<div class="content">
			...
			<div class="right_content">
				<div class="box_1">
					<div class="box_1_top">
						<p class="head_info">浅谈江湖</p>
					</div>
					<div class="box_1_left_bg">
					</div>
					<div class="box_1_right_banner">
						<div class="info_1">
							每个人心中都有一个江湖梦
						</div>
						<div class="info_2">
						...
						<!-- banner start -->
						<div class="banner_big_img">
							<ul id="big_img_ul">
								<li>
									<a href="#"><img src="${pageContext.request.contextPath}/images/banner_imgs/1.jpg" width="590" height="300"/></a>
								</li>
								<li>
									<a href="#"><img src="${pageContext.request.contextPath}/images/banner_imgs/2.jpg" width="590" height="300"/></a>
								</li>
								<li>
									<a href="#"><img src="${pageContext.request.contextPath}/images/banner_imgs/3.jpg" width="590" height="300"/></a>
								</li>
								<li>
									<a href="#"><img src="${pageContext.request.contextPath}/images/banner_imgs/4.jpg" width="590" height="300"/></a>
								</li>
								<li>
									<a href="#"><img src="${pageContext.request.contextPath}/images/banner_imgs/5.jpg" width="590" height="300"/></a>
								</li>
							</ul>
							<div class="prev">
							</div>
						...
						<div class="banner_small_img">
							<ul id="small_img_ul">
								<li>
									<a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/images/banner_imgs/1.jpg" width="100" height="70" class="on"/></a>
								</li>
								<li>
									<a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/images/banner_imgs/2.jpg" width="100" height="70"/></a>
								</li>
								<li>
									<a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/images/banner_imgs/3.jpg" width="100" height="70"/></a>
								</li>
								<li>
									<a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/images/banner_imgs/4.jpg" width="100" height="70"/></a>
								</li>
								<li>
									<a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/images/banner_imgs/5.jpg" width="100" height="70"/></a>
								</li>
							</ul>
						</div>
						<!-- end banner -->
