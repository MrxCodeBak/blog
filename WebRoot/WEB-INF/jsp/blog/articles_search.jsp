...
<head>
	...
	<!-- css -->
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/article_search.css"/><!-- 本页样式 -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/article_search.js"></script><!-- 本页js -->	
	<script type="text/javascript">
		//变量供js文件使用
		var path = "${pageContext.request.contextPath}";
		var articleSoTitle = "${tip}";
		...
		<div class="content">
			...
			<div class="right_content">
				<div class="box_2">
					...
					<div class="box_2_content">
						<div class="not_find animated zoomInDown">
							<img src="${pageContext.request.contextPath}/images/not_find.png" width="100" height="100"/>
							<span>您搜索的内容不存在~</span>
						</div>
						<ul>
							<!-- 叠加文章li start -->
							<s:iterator value="articleSos">
								<li class="ww_ul animated zoomInDown">
									<div class="c_1">
										<span class="c_1_3">
											<a href="${pageContext.request.contextPath}/article/qt_getArticleContentByArticleId.jspx?articleId=<s:property value="id"/>"><s:property value="article_title" escapeHtml="false"/></a>
										</span>
									</div>
									<div class="c_2">
										<div class="c_2_2">
